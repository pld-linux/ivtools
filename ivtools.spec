...
IVTools jest prostym edytorem stworzonym do współpracy z narzędziami
takimi jak PostScript, TeX, oraz do tworzenia grafik udostępnianych
poprzez WWW.
...
Pakiet programistyczny, zawiera pliki nagłówkowe niezbędne do
kompilacji przykładów, i własnych programów używających pakietu
IVTools.
